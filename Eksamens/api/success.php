...
function build_booking_confirmation_email(string $userName, ?string $scheduledAt, string $consultationType, string $lang = 'lv'): string {
    ...
    $html .= '<div style="padding:32px 32px 24px;background:rgb(20, 150, 127);color:#ffffff;">';
    $html .= '<h1 style="margin:0;font-size:24px;line-height:1.2;font-weight:600;">' . htmlspecialchars(t('email_subject'), ENT_QUOTES, 'UTF-8') . '</h1>';
    $html .= '</div>';
    ...
    $html .= '<div style="background:rgb(20, 150, 127);padding:16px;border-radius:6px;margin:18px 0;">';
    $html .= '<p style="margin:0 0 10px;font-size:15px;line-height:1.6;color:#ffffff;"><strong>' . htmlspecialchars(t('email_payment_ok'), ENT_QUOTES, 'UTF-8') . '</strong></p>';
    $html .= '<p style="margin:8px 0;font-size:14px;line-height:1.6;color:#ffffff;"><strong>' . htmlspecialchars(t('email_type_line', $consultationLabel), ENT_QUOTES, 'UTF-8') . '</strong></p>';
    $html .= '<p style="margin:8px 0;font-size:14px;line-height:1.6;color:#ffffff;"><strong>' . htmlspecialchars(t('email_time_line', $timeText), ENT_QUOTES, 'UTF-8') . '</strong></p>';
    $html .= '</div>';
